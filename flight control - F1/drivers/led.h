...
#define LED1_OFF         ANO_GPIO_LED->BRR = ANO_Pin_LED1   //H
...
#define LED4_OFF         ANO_GPIO_LED->BRR = ANO_Pin_LED4
#define LED4_ON          ANO_GPIO_LED->BSRR = ANO_Pin_LED4

#else
//新版

#define LED1_OFF         ANO_GPIO_LED->BSRR = ANO_Pin_LED1   //H
#define LED1_ON          ANO_GPIO_LED->BRR = ANO_Pin_LED1		//L
#define LED2_ON          ANO_GPIO_LED->BSRR = ANO_Pin_LED2
#define LED2_OFF         ANO_GPIO_LED->BRR = ANO_Pin_LED2
#define LED3_ON          ANO_GPIO_LED->BRR = ANO_Pin_LED3
#define LED3_OFF         ANO_GPIO_LED->BSRR = ANO_Pin_LED3
#define LED4_ON          ANO_GPIO_LED->BRR = ANO_Pin_LED4
#define LED4_OFF         ANO_GPIO_LED->BSRR = ANO_Pin_LED4

#endif

/***************LED GPIO定义******************/
#define ANO_RCC_LED			RCC_APB2Periph_GPIOD
#define ANO_GPIO_LED		GPIOD
#define ANO_Pin_LED1		GPIO_Pin_0
#define ANO_Pin_LED2		GPIO_Pin_1
#define ANO_Pin_LED3		GPIO_Pin_2
#define ANO_Pin_LED4		GPIO_Pin_3
/*********************************************/
/*
