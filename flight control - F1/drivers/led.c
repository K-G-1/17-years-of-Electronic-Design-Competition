...
//	GPIO_SetBits(ANO_GPIO_LED, ANO_Pin_LED4);		
 	...
 	GPIO_SetBits(ANO_GPIO_LED, ANO_Pin_LED1);		//PA.4
 	GPIO_SetBits(ANO_GPIO_LED, ANO_Pin_LED2);		//PA.5
 	GPIO_SetBits(ANO_GPIO_LED, ANO_Pin_LED3);		//PA.6
 	GPIO_SetBits(ANO_GPIO_LED, ANO_Pin_LED4);	  //PA.7
