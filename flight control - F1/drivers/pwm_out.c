...
#define INIT_DUTY 1000 //u16(1000/0.25)
...
//	hz_set = LIMIT (hz_set,1,72000000);
...
void SetPwm(int16_t pwm[MAXMOTORS],s16 min,s16 max)
{
	...
	TIM2->CCR3 = ( pwm_tem[CH_out_Mapping[0]] ) + INIT_DUTY;				//1	
	TIM2->CCR2 = ( pwm_tem[CH_out_Mapping[1]] ) + INIT_DUTY;				//2
	TIM2->CCR1 = ( pwm_tem[CH_out_Mapping[2]] ) + INIT_DUTY;				//3	
	TIM2->CCR4 = ( pwm_tem[CH_out_Mapping[3]] ) + INIT_DUTY;				//4
