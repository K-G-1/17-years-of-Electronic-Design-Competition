...
void Duty_10ms()
{
    Openmv_DT_Data_Receive_Anl(usart3_save);
	  Auto_switch_2(0.01f);
//    GY_530_Duty();
...
{
    float inav_time ;
    inav_time  = Get_Cycle_T(4)/1000000.0f;
   
    inav_calution(inav_time);
...
void Duty_50ms()
{
	...
	set_light_sound(camera_Trance.sound);      //声光报警
