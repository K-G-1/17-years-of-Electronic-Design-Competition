...
#define      OV7725_WRST_GPIO_CLK                     RCC_AHB1Periph_GPIOA
...
#define      OV7725_RRST_GPIO_PIN                     GPIO_Pin_7
...
typedef struct 
{
	...
	u8 horizontal_64_old;
	u8 vertical_64_old;
	u8 vertical_172_old;
	
	
}_mid_x_line;
extern  _mid_x_line mid_x_line;
extern _camera_data camera_data;
extern uint16_t camera_dis_buf[100][100], camera_dis2_buf[100][100], camera_dis3_buf[100][100], camera_min_data[2][100];									
extern u8 USART2_Tx_data[100];
