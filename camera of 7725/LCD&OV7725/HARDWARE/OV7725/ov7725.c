...
OV7725_MODE_PARAM cam_mode =
{
	...
	.lcd_sx = 0,
	.lcd_sy = 0,
	.lcd_scan = 0, //LCD扫描模式，本横屏配置可用1、3、5、7模式
...
ErrorStatus OV7725_Init(void)
{
	...
	//LCD_ShowString(30,70,210,24,24,"Config Start");
	
	if( 0 == SCCB_WriteByte ( 0x12, 0x80 ) ) /*复位sensor */
	{
		LCD_ShowString(30,100,210,24,24,"write data error");		
		return ERROR ;
	}	

	if( 0 == SCCB_ReadByte( &Sensor_IDCode, 1, 0x0b ) )	 /* 读取sensor ID号*/
	{
		LCD_ShowString(30,130,210,24,24,"read id faild");		
		return ERROR;
	}
	//LCD_ShowString(30,160,210,24,24,"Sensor ID");	
	...
	LCD_ShowString(30,190,210,24,24,"config success");
	return SUCCESS;
}
